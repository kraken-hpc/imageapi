...
// NewUnmountOverlayParamsWithTimeout creates a new UnmountOverlayParams object
...
// NewUnmountOverlayParamsWithContext creates a new UnmountOverlayParams object
...
// NewUnmountOverlayParamsWithHTTPClient creates a new UnmountOverlayParams object
...
/*UnmountOverlayParams contains all the parameters to send to the API endpoint
for the unmount overlay operation typically these are written to a http.Request
*/
...
func (o *UnmountOverlayParams) WithContext(ctx context.Context) *UnmountOverlayParams {
	o.SetContext(ctx)
	return o
}
