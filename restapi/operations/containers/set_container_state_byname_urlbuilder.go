...
func (o *SetContainerStateBynameURL) WithBasePath(bp string) *SetContainerStateBynameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *SetContainerStateBynameURL) Build() (*url.URL, error) {
	...
	var _path = "/container/byname/{name}/{state}"

	name := o.Name
	if name != "" {
		_path = strings.Replace(_path, "{name}", name, -1)
	} else {
		return nil, errors.New("name is required on SetContainerStateBynameURL")
	}
	...
	if state != "" {
		...
		return nil, errors.New("state is required on SetContainerStateBynameURL")
	}
...
func (o *SetContainerStateBynameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SetContainerStateBynameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SetContainerStateBynameURL")
	}
