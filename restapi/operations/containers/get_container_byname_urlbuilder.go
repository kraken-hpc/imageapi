...
func (o *GetContainerBynameURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("name is required on GetContainerBynameURL")
	}
...
func (o *GetContainerBynameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetContainerBynameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetContainerBynameURL")
	}
