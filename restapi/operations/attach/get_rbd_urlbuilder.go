...
func (o *GetRbdURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetRbdURL")
	}
...
func (o *GetRbdURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRbdURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRbdURL")
	}
