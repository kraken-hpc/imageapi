...
// GetRbdParams contains all the bound params for the get rbd operation
...
func (o *GetRbdParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
