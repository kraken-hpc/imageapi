...
// UnmapRbdParams contains all the bound params for the unmap rbd operation
...
func (o *UnmapRbdParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
