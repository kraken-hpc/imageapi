...
// MapRbdParams contains all the bound params for the map rbd operation
...
func (o *MapRbdParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("rbd", "body", ""))
			} else {
				res = append(res, errors.NewParseError("rbd", "body", "", err))
			}
		} else {
