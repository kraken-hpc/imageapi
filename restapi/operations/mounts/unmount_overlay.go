...
func (fn UnmountOverlayHandlerFunc) Handle(params UnmountOverlayParams) middleware.Responder {
	return fn(params)
}
...
func NewUnmountOverlay(ctx *middleware.Context, handler UnmountOverlayHandler) *UnmountOverlay {
	return &UnmountOverlay{Context: ctx, Handler: handler}
}
...
func (o *UnmountOverlay) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewUnmountOverlayParams()
