...
// GetMountRbdParams contains all the bound params for the get mount rbd operation
...
func (o *GetMountRbdParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
